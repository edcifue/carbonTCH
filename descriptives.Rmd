...
```{r,include=FALSE}
INV <- read.csv('./data/all_inventories_v4_agb.csv')
db.parcela <- read.csv('./data/db_parcela_v1_agb.csv')
var <- "parcela"
...
legend("topright",inset=c(-0.3,0),legend=c(unique(db.parcela$location)),pch=c(20),col=c(rainbow(n=25)),cex=0.6)
...
legend("topright",inset=c(-0.3,0),legend = c(unique(db.parcela$sizeplot)),pch=c(20),col=c(topo.colors(n=4)),cex=0.6)
