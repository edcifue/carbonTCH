...
# Load data
# mini
INV <- read.csv('./data/db_parcela_v2_agb.csv', stringsAsFactors = F)
...
```{r, include=FALSE}
##Plot areas
load("./data/20210505_to_Rmd.RData")
...
dbmodel<- read.csv('./data/20200420_db_model_v1.csv')
...
```{r,include=FALSE}
### Asner data -----
asma <- read.csv('./data/Asner_Mascaro_SI.csv')
names(asma)[1]<-"Region"
library(pals) 
